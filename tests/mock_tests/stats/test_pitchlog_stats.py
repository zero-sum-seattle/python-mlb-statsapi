...
class TestMlbDataApiMock(unittest.TestCase):
    ...
    def test_hitting_play_log_for_player(self, m):
        ...
        m.get('https://statsapi.mlb.com/api/v1/people/665742/stats?stats=pitchLog&group=hitting', json=self.mock_hitting_playlog,
        status_code=200)
        self.stats = ['pitchLog']
        self.groups = ['hitting']
    ...
    def test_pitching_play_log_for_player(self, m):
        """get_player_game_stats should return a dict with stats"""
        m.get('https://statsapi.mlb.com/api/v1/people/660271/stats?stats=pitchLog&group=pitching', json=self.mock_pitching_playlog,
        status_code=200)
        self.stats = ['pitchLog']
