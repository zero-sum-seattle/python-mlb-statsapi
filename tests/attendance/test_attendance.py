...
class TestAttendance(unittest.TestCase):
    ...
    def test_attendance_has_attributes(self):
        ...
        self.assertTrue(hasattr(self.attendance_team_away, "copyright"))
        ...
        self.assertTrue(hasattr(self.attendance_team_home, "copyright"))
        ...
        self.assertTrue(hasattr(self.attendance_season, "copyright"))
