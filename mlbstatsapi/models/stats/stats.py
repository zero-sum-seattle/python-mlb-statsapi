from .splits import Splits, HittingSplits, PitchingSplits
...
class Stats:
    ...
    stat_group: str 
    stat_type: str  
    splits: List[Union[Splits, HittingSplits, PitchingSplits]]
    ...
    def _build_splits(self, splits: List[Splits]) -> None:
        splitList = []
