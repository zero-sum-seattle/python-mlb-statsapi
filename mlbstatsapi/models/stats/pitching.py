...
class SimplePitchingSplit(MLBBaseModel):
    ...
    innings_pitched : str
        The number of innings pitched by the pitcher. Represented as MLB
        innings notation (e.g. "6.2" means 6 2/3 innings), not a true
        decimal value.
    wins : int
    ...
    strike_percentage: Optional[float] = Field(default=None, alias="strikePercentage")
    ...
    win_percentage: Optional[float] = Field(default=None, alias="winPercentage")
    pitches_per_inning: Optional[float] = Field(default=None, alias="pitchesPerInning")
    ...
    strikeouts_per_9_inn: Optional[float] = Field(default=None, alias="strikeoutsPer9Inn")
    walks_per_9_inn: Optional[float] = Field(default=None, alias="walksPer9Inn")
    hits_per_9_inn: Optional[float] = Field(default=None, alias="hitsPer9Inn")
    runs_scored_per_9: Optional[float] = Field(default=None, alias="runsScoredPer9")
    home_runs_per_9: Optional[float] = Field(default=None, alias="homeRunsPer9")
...
class AdvancedPitchingSplit(MLBBaseModel):
    ...
    """
    age: Optional[int] = None
    winning_percentage: Optional[float] = Field(default=None, alias="winningPercentage")
    runs_scored_per_9: Optional[float] = Field(default=None, alias="runsScoredPer9")
    batters_faced: Optional[int] = Field(default=None, alias="battersFaced")
    ...
    slg: Optional[float] = None
    ops: Optional[float] = None
    strikeouts_per_9: Optional[float] = Field(default=None, alias="strikeoutsPer9")
    base_on_balls_per_9: Optional[float] = Field(default=None, alias="baseOnBallsPer9")
    home_runs_per_9: Optional[float] = Field(default=None, alias="homeRunsPer9")
    hits_per_9: Optional[float] = Field(default=None, alias="hitsPer9")
    strikeouts_to_walks: Optional[float] = Field(default=None, alias="strikeoutsToWalks")
    stolen_bases: Optional[int] = Field(default=None, alias="stolenBases")
    caught_stealing: Optional[int] = Field(default=None, alias="caughtStealing")
    ...
    strikeouts_minus_walks_percentage: Optional[float] = Field(default=None, alias="strikeoutsMinusWalksPercentage")
    gidp_percentage: Optional[float] = Field(default=None, alias="gidpPercentage")
    batters_faced_per_game: Optional[float] = Field(default=None, alias="battersFacedPerGame")
    ...
    whiff_percentage: Optional[float] = Field(default=None, alias="whiffPercentage")
